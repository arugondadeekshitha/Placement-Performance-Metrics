		      ...
		      <div class="center one">
				...
				<div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Year Of Pass</label>
                                    ...
                                    <input type="text" class="form-control" id="website" name="percentage">
                                    <small>Aggregate of 3 Years</small>
                                    </div>
									<div class="form-row">
                                    <div class="form-group col-md-6">
                                    <label for="website">10th Percentage</label>
                                    <input type="text" class="form-control" id="website" name="10thpercentage">
                                    </div>
                                    <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">skills</label>
                                    <input type="text" class="form-control" id="website" name="skills">
                                    </div>
                                </div>
		        </div>
				<div class="form-row">
			        <div class="form-group col-md-5">
			          ...
			          <select class="course" name="course" style="width:200px" required>
