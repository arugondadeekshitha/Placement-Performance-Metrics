...
CREATE TABLE IF NOT EXISTS `studentlogin` (
  ...
  `10thpercentage` varchar(10) DEFAULT NULL,
...
INSERT INTO `studentlogin` (`id`, `uname`, `pwd`, `fname`, `lname`, `email`, `phone`, `secque`, `secans`, `course`, `percentage`, `yop`, `10thpercentage`, `skills`) VALUES
('21881A05A4', 'vijay', '12345', 'vijay', 'nallabolu', 'vijay@gmail.com', '7989408814', 'Which is Favourite Food?', 'biryani', 'CSE', '80', '2025', '85', 'Web technologies,problem solving,DSA,Data analytics'),
('21881A0659', 'girishgv21', '12345', 'Girish', 'G V', 'girishgv21@gmail.com', '9742492316', 'Which is your Favourite Mobile Company?', 'Motorola', 'CIVIL', '78', '2025', '92', NULL),
('21881A0599', 'mohith', '12345', 'Mohith', 'SB', 'mohith@gmail.com', '9876789865', 'Which is your First Phone?', 'Samsung', 'CSE', '82', '2025', NULL, 'Web technologies,Data analytics'),
('21881A8408', 'vinay', '12345', 'Vinay ', 'Kumar', 'vinay@gmail.com', '9089876789', 'Which is your First Phone?', 'Nokia', 'ECE', '76', '2025', '81', 'micro processor,micro controller,design architechture'),
('21881A0606', 'bharath', '12345', 'Bharath', 'N', 'bharath@gmail.com', '9632629993', 'Which is your Favourite Mobile Company?', 'OnePlus', 'MEC', '82', '2025', '59', NULL);
COMMIT;
