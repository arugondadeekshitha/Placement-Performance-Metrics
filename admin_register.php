...
<body>
    ...
    <div class="content" style="margin-top: 20px; margin-left: -40px;">
    	<h1 class="form-row justify-content-center" style="margin-left: 60px;">Admin SignUp</h1> <br>
    	...
    	<form action="admin_register.inc.php" autocomplete="off" method="POST">
		      ...
		      <div class="center one">
		        <div class="form-row">
		        	<div class="form-group col-md-5">
			          ...
			          <input type="text" class="form-control" id="sid" name="aid" placeholder="Admin ID" required>
			        </div>
			        <div class="form-group col-md-5">
