		      ...
		      <div class="center one">
		        <div class="form-row">
			        <div class="form-group">
			          ...
			          <input type="text" class="form-control" placeholder="Enter Admin ID" id="cname" name="uname" style="width: 250px;" required>
		        ...
		        <div class="form-row">
		        	<div class="form-group">
			          ...
			          <input type="password" class="form-control" placeholder="Enter Admin Password" id="cid" name="pwd1" style="width: 250px;" required>
								<div class="invalid-feedback">
		        	...
		        	<div class="form-row">
						...
						<div class="form-group">
		        			<a href="admin_register.php" class="btn btn-light btn-sm"><u>Don't have an account?, Sign Up!</u></a>
		        		</div>
		      </div>
		    </div>
		  </form> 
