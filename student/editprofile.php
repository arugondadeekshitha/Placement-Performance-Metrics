                            ...
                            while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                <label for="exampleInputEmail1">Course</label>
                                    <select class="custom-select" name="course">
                                        ...
                                        <option value="BE/BTECH">CSE</option>
                                        <option value="BBA">IT</option>
                                        <option value="BCOM">ECE</option>
                                        <option value="BCA">MECH</option>
                                        <option value="ME/MTECH">CIVIL</option>
                                        <option value="MCOM">CSM</option>
                                        <option value="MBA">AIML</option>
                                        <option value="MCA">AIDS</option>
                                    </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" id="website" name="10thpercentage" value="<?php echo $row['10thpercentage']; ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">skills</label>
                                    <input type="text" class="form-control" id="website" name="skills" value="<?php echo $row['skills']; ?>">
                                    </div>
                                </div>
