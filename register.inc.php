...
<body>
    <?php 
            ...
            if (isset($_POST['signup'])) {
                ...
                $skills = $_POST['skills'];
                if ($pwd1 == $pwd2) {
                    $sql = "insert into studentlogin(id,uname, pwd, fname, lname, email, phone, secque, secans,course,percentage,yop,10thpercentage,skills) values('$sid','$uname', '$pwd1', '$fname', '$lname', '$email', '$phone', '$secque', '$secans','$course','$percentage','$yop','$tenthpercentage','$skills');";
